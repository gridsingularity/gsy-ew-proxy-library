...
from gsy_ew_proxy.dataclasses import EnergyTrade, MarketSlotInfo, MarketType
from gsy_ew_proxy.ewcg_connection import EWClientGatewayConnection
from gsy_ew_proxy.ewcg_strategy import TIMEZONE
...
class TestPostBid:
    ...
    def test_returns_client_gateway_message_id():
        ...
        conn = EWClientGatewayConnection("trader-1", "Prosumer")
        with patch("gsy_ew_proxy.ewcg_connection.httpx.post", post):
...
class TestListener:
    ...
    def test_dispatches_market_slot_to_callback():
        ...
        with patch("gsy_ew_proxy.ewcg_connection.ws_connect", factory):
